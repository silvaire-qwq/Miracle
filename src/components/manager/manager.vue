        ...
        <div class="textPlace">
          ...
          <div class="actions">
            <a
              ...
              }/new/main/src/markdown?filename=${getTimeString()}.md&value=${encodeURIComponent(
                postFileTemplate
              )}`"
              target="_blank"
            >
      ...
      >
        <div class="textPlace">
          ...
          <div class="actions">
            ...
            <a
              :href="`https://github.com/${globalConfig.githubRepo}/edit/main/src/content${post.url}.md`"
              target="_blank"
            >
              <Icon icon="fluent:edit-12-regular" />
            </a>
            <a
              :href="`https://github.com/${globalConfig.githubRepo}/delete/main/src/content${post.url}.md`"
              target="_blank"
            >
      ...
      >
        <div class="textPlace">
          ...
          <div class="actions">
            ...
            <a
              :href="`https://github.com/${globalConfig.githubRepo}/delete/main/src/config/moments/${m.fileName}`"
              target="_blank"
            >
              <Icon icon="fluent:delete-12-regular" class="delete" />
            </a>
      ...
      >
        <div class="textPlace">
          ...
          <div class="actions">
            ...
            <a
              :href="`https://github.com/${globalConfig.githubRepo}/edit/main/src/config/friends/${f.fileName}`"
              target="_blank"
            >
              <Icon icon="fluent:edit-12-regular" />
            </a>
            <a
              :href="`https://github.com/${globalConfig.githubRepo}/delete/main/src/config/friends/${f.fileName}`"
              target="_blank"
            >
              <Icon icon="fluent:delete-12-regular" class="delete" />
            </a>
